...
export default function SpecialMenu() {
  return (
    <>
      <div>
        <div className="bg-fixed-pic4 h-[100vh] opacity-95 w-full max-lg:w-[100%] max-lg:mb-auto max-sm:w-[100%] max-lg:mt-10 max-sm:overflow-x-hidden">
          <div className="flex items-center justify-center m-auto h-full">
            ...
            <div className=" flex  items-center justify-center max-lg:flex-col max-lg:mt-auto ">
              <div className="text-white flex flex-col items-center justify-center bg-white max-sm:w-[90%]">
                ...
                <div className="flex flex-row max-lg:flex-col gap-20 items-center justify-center m-10 max-sm:w-[80%]">
                  {/* first menu colunm */}
                  <div className="flex flex-col items-start text-black max-sm:w-full">
