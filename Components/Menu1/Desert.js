...
export default function Desert() {
  return (
    <>
    <div className="text-white flex flex-col items-center justify-center mt-[50%] mb-[50%]  max-sm:overflow-x-hidden max-sm:w-[90%]">
    <div className="bg-fixed-pic8 h-[55vh] opacity-95 w-full max-lg:w-[90%]">
