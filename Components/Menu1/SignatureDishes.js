...
export default function SignatureDishes() {
  return (
    <>
      <div className="text-white flex flex-col items-center justify-center mb-44 max-lg:mb-[20%] max-sm:mb-[30%] max-sm:overflow-x-hidden max-sm:w-[90%]">
        <div className="text-5xl font-bold mt-44 max-sm:text-3xl">
          Signature Dish
        </div>
        ...
        {/* menus */}
        <div className="flex flex-row gap-20 items-center justify-center max-lg:flex-col max-sm:w-[90%]">
          {/* first menu colunm */}
